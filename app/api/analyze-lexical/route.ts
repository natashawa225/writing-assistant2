...
export async function POST(request: NextRequest) {
  try {
    ...
    - For each AWL word:
      * suggestion.reason: write a reflective prompt to guide students to revise, GIVE A REFLECTIVE PROMPT, DONT GIVE THE ANSWER. for example: "Think of a more formal verb often used in academic writing that means to obtain or to receive."
    ...
    - For each AFL phrase in: ${JSON.stringify(aflSuggestions)}:
      * suggestion.reason: write a reflective prompt to guide students to revise. GIVE A REFLECTIVE PROMPT, DONT GIVE THE ANSWER. Give a subtle clue instead of the exact replacement.
